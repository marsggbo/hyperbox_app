...
template = '''
bash scripts/train_nb201_c100.sh 3 "c10_8net_5batch" "+model.num_subnets=4 +model.sample_interval=1 seed=999 hydra.job.name=debug ipdb_debug=True logger.wandb.offline=True" 
'''
